...
class MainActivity4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var rezume = findViewById<Button>(R.id.rezume)
        var intent_set = Intent(this,MainActivity5::class.java)
        var intent_set2 = Intent(this,MainActivity3::class.java)

        var intent_au = Intent(this,MainActivity::class.java)
        var intent_lkad = Intent(this,MainActivity6::class.java)

        rezume.setOnClickListener{
            startActivity(intent_set2)
        }
